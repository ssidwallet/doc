...
Many aspects of the FlexID open standard works with any DID method, but verifiers/relying parties may not accept all DID methods. You should be very careful to consider the threat model of the method you choose.
...
{
{
  ...
  "id": "did:web:flexid.github.io",
  "assertionMethod": [
    {
      "id": "did:web:flexid.github.io#z6MkrXSQTybtqyMasfSxeRBJxDvDUGqb7mt9fFVXkVn6xTG7",
      "type": "Ed25519VerificationKey2020",
      "controller": "did:web:flexid.github.io",
...
You can see an example of the [FlexID samples DID document](https://flexid.github.io/samples/.well-known/did.json).
